            ...
            if (import_record_list_id.get() < v.all_import_records.len) {
                ...
                for (import_records) |*import_record| {
                    ...
                    if (other_source.isValid()) {
                        ...
                        const is_inlined = import_record.source_index.isValid() and v.all_urls_for_css[import_record.source_index.get()].len > 0 and v.all_loaders[import_record.source_index.get()] != .file;
